	...
	echo '	
		...
		<div id="menu">
			...
			<nav id="menu_text">
				...
				<section id="sidebar">
					<a href="http://www.instagram.com/patriciogonzalezvivo" target="_blank"><img src="/images/icons/instagram.png" width="32" class="icon" style="position: relative;left: 5px;"/></a>
					<a href="https://twitter.com/intent/follow?screen_name=patriciogv"><img src="/images/icons/twitter.png" width="34" class="icon"/></a>
					<a href="https://bsky.app/profile/patricio.io"><img src="/images/icons/bsky.png" width="24" class="icon" style="top: -4px;position: relative;"/></a>
				</section >
			</nav>
		</div>	
	';
