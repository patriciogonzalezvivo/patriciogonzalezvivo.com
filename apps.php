...
<?php include("sidebar.php");?>
	<section class="content">
		...
		<article class="item">
			<a href="2011/eden/"><img class="roundPhotoTh" src="2011/eden/thumb.jpg" alt="Eden 1.0"/></a>
			<p>2011 <strong>Eden 1.0</strong>: GLSL bounch of shaders that simulates a the atmoshpere, biosphere, geoshpere and biosphere of a 3D scanned surface</p>
		</article>
		<article class="item">
		...
		<article class="item">
			<a href="2009/joyoflight/"><img class="roundPhotoTh" src="2009/joyoflight/thumb.jpg" alt="JoyOfLight"/></a>
