...
<?php include("../../sidebar.php");?>
	...
	<section class="content">
		...
		<article>
			<p><strong>Oca game</strong> propous an updated view of traditional table games. For that, it uses animation and interaction as a medium that holds a new paradigm where the main characters of stories and games colaborate and evoluve. This new posibilites are mixed with original simbolic content of the ancient Oca game.</p>
			<p>This game is part of a bigest project call <strong>"La Mesa del Tiempo"</strong> was designed especially for the Toy Museum of San Isidro, seeks to deploy the technological dimension of the current game, find points of intersection between technology, gaming and community.</p>
		</article>
