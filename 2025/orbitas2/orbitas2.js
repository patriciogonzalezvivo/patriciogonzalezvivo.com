...
// include: /tmp/tmpc27chotz.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'orbitas2.data';
      var REMOTE_PACKAGE_BASE = 'orbitas2.data';
...
Module['FS_createPath']("/", "shaders", true, true);
    ...
    for (var file of metadata['files']) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](`fp ${name}`);
          ...
          Module['removeRunDependency']('datafile_orbitas2.data');
      }
      Module['addRunDependency']('datafile_orbitas2.data');
    ...
    loadPackage({"files": [{"filename": "/png/diffuse.png", "start": 0, "end": 132262}, {"filename": "/png/elements.png", "start": 132262, "end": 169320}, {"filename": "/shaders/earth.frag", "start": 169320, "end": 169847}, {"filename": "/shaders/earth.vert", "start": 169847, "end": 170615}, {"filename": "/shaders/icon.frag", "start": 170615, "end": 171480}, {"filename": "/shaders/icon.vert", "start": 171480, "end": 171943}, {"filename": "/shaders/icon_moon.frag", "start": 171943, "end": 173494}, {"filename": "/shaders/moon.frag", "start": 173494, "end": 174483}, {"filename": "/shaders/moon.vert", "start": 174483, "end": 175342}, {"filename": "/shaders/stars.frag", "start": 175342, "end": 176110}, {"filename": "/shaders/stars.vert", "start": 176110, "end": 177150}], "remote_package_size": 177150});

  })();

// end include: /tmp/tmpc27chotz.js
// include: /tmp/tmp8mny54vy.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmp8mny54vy.js
// include: /tmp/tmpo52h8diz.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpo52h8diz.js
...
function findWasmBinary() {
  return locateFile('orbitas2.wasm');
}
