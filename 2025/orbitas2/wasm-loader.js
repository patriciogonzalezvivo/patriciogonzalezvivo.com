        ...
        window.Module = {
            ...
            postRun: () => {
                ...
                navigator.geolocation.getCurrentPosition((position) => {
                    ...
                    window.Module.setLocation(lat, long);
                    console.log('WASM Location set to', lat, long);
                });
            },
...
customElements.define('wasm-loader', Loader); 