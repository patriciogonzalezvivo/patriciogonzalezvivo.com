...
In recent years, his practice has converged on the plotter-and-oil painting series [Hybrids](2025/hybrids/) and [Santos](2026/santos/), in which computer vision draws a structural scaffold on canvas that González Vivo then completes by hand. Neither system alone achieves what both develop together: the plotter carries the photograph's accuracy into the canvas; the brush carries what measurement cannot: attention, risk, the presence of a body in time.
