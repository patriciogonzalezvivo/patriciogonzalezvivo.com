...
// include: /tmp/tmpaft6luyp.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'weaver2.data';
      var REMOTE_PACKAGE_BASE = 'weaver2.data';
    ...
    for (var file of metadata['files']) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](`fp ${name}`);
          ...
          Module['removeRunDependency']('datafile_weaver2.data');
      }
      Module['addRunDependency']('datafile_weaver2.data');
...
// end include: /tmp/tmpaft6luyp.js
// include: /tmp/tmphwumx2m3.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmphwumx2m3.js
// include: /tmp/tmpi4b5b09_.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpi4b5b09_.js
...
function findWasmBinary() {
  return locateFile('weaver2.wasm');
}
...
var ASM_CONSTS = {
  3332128: ($0) => { if (typeof Module['onExportProgress'] === 'function') Module['onExportProgress']($0); },  
 3332218: ($0, $1, $2) => { if (typeof Module['onExportComplete'] === 'function') Module['onExportComplete']($0, $1, $2); }
};

// Imports from the Wasm binary.
var _setLocationA = Module['_setLocationA'] = makeInvalidEarlyAccess('_setLocationA');
var _getLocationALat = Module['_getLocationALat'] = makeInvalidEarlyAccess('_getLocationALat');
var _getLocationALng = Module['_getLocationALng'] = makeInvalidEarlyAccess('_getLocationALng');
var _setLocationB = Module['_setLocationB'] = makeInvalidEarlyAccess('_setLocationB');
var _getLocationBLat = Module['_getLocationBLat'] = makeInvalidEarlyAccess('_getLocationBLat');
var _getLocationBLng = Module['_getLocationBLng'] = makeInvalidEarlyAccess('_getLocationBLng');
var _setCityIdA = Module['_setCityIdA'] = makeInvalidEarlyAccess('_setCityIdA');
var _setCityIdB = Module['_setCityIdB'] = makeInvalidEarlyAccess('_setCityIdB');
var _getCityIdA = Module['_getCityIdA'] = makeInvalidEarlyAccess('_getCityIdA');
var _getCityIdB = Module['_getCityIdB'] = makeInvalidEarlyAccess('_getCityIdB');
var _setTimeANow = Module['_setTimeANow'] = makeInvalidEarlyAccess('_setTimeANow');
var _setTimeBNow = Module['_setTimeBNow'] = makeInvalidEarlyAccess('_setTimeBNow');
var _getTimeANow = Module['_getTimeANow'] = makeInvalidEarlyAccess('_getTimeANow');
var _getTimeBNow = Module['_getTimeBNow'] = makeInvalidEarlyAccess('_getTimeBNow');
var _setTimeALocal = Module['_setTimeALocal'] = makeInvalidEarlyAccess('_setTimeALocal');
var _setTimeBLocal = Module['_setTimeBLocal'] = makeInvalidEarlyAccess('_setTimeBLocal');
var _getTimeALocal = Module['_getTimeALocal'] = makeInvalidEarlyAccess('_getTimeALocal');
var _getTimeBLocal = Module['_getTimeBLocal'] = makeInvalidEarlyAccess('_getTimeBLocal');
var _setTimeA = Module['_setTimeA'] = makeInvalidEarlyAccess('_setTimeA');
var _setTimeB = Module['_setTimeB'] = makeInvalidEarlyAccess('_setTimeB');
var _getTimeAYear = Module['_getTimeAYear'] = makeInvalidEarlyAccess('_getTimeAYear');
var _getTimeAMonth = Module['_getTimeAMonth'] = makeInvalidEarlyAccess('_getTimeAMonth');
var _getTimeADay = Module['_getTimeADay'] = makeInvalidEarlyAccess('_getTimeADay');
var _getTimeAHour = Module['_getTimeAHour'] = makeInvalidEarlyAccess('_getTimeAHour');
var _getTimeAMinute = Module['_getTimeAMinute'] = makeInvalidEarlyAccess('_getTimeAMinute');
var _getTimeBYear = Module['_getTimeBYear'] = makeInvalidEarlyAccess('_getTimeBYear');
var _getTimeBMonth = Module['_getTimeBMonth'] = makeInvalidEarlyAccess('_getTimeBMonth');
var _getTimeBDay = Module['_getTimeBDay'] = makeInvalidEarlyAccess('_getTimeBDay');
var _getTimeBHour = Module['_getTimeBHour'] = makeInvalidEarlyAccess('_getTimeBHour');
var _getTimeBMinute = Module['_getTimeBMinute'] = makeInvalidEarlyAccess('_getTimeBMinute');
var _setTimezoneA = Module['_setTimezoneA'] = makeInvalidEarlyAccess('_setTimezoneA');
var _setTimezoneB = Module['_setTimezoneB'] = makeInvalidEarlyAccess('_setTimezoneB');
var _getTimezoneA = Module['_getTimezoneA'] = makeInvalidEarlyAccess('_getTimezoneA');
var _getTimezoneB = Module['_getTimezoneB'] = makeInvalidEarlyAccess('_getTimezoneB');
var _setNameA = Module['_setNameA'] = makeInvalidEarlyAccess('_setNameA');
var _setNameB = Module['_setNameB'] = makeInvalidEarlyAccess('_setNameB');
var _getNameA = Module['_getNameA'] = makeInvalidEarlyAccess('_getNameA');
var _getNameB = Module['_getNameB'] = makeInvalidEarlyAccess('_getNameB');
var _setTheme = Module['_setTheme'] = makeInvalidEarlyAccess('_setTheme');
var _setAutohideTimeline = Module['_setAutohideTimeline'] = makeInvalidEarlyAccess('_setAutohideTimeline');
var _getAutohideTimeline = Module['_getAutohideTimeline'] = makeInvalidEarlyAccess('_getAutohideTimeline');
var _setShowA = Module['_setShowA'] = makeInvalidEarlyAccess('_setShowA');
var _getShowA = Module['_getShowA'] = makeInvalidEarlyAccess('_getShowA');
var _setShowGlobes = Module['_setShowGlobes'] = makeInvalidEarlyAccess('_setShowGlobes');
var _getShowGlobes = Module['_getShowGlobes'] = makeInvalidEarlyAccess('_getShowGlobes');
var _setShowB = Module['_setShowB'] = makeInvalidEarlyAccess('_setShowB');
var _getShowB = Module['_getShowB'] = makeInvalidEarlyAccess('_getShowB');
var _setYearless = Module['_setYearless'] = makeInvalidEarlyAccess('_setYearless');
var _getYearless = Module['_getYearless'] = makeInvalidEarlyAccess('_getYearless');
var _setStarLevel = Module['_setStarLevel'] = makeInvalidEarlyAccess('_setStarLevel');
var _getStartLevel = Module['_getStartLevel'] = makeInvalidEarlyAccess('_getStartLevel');
var _setFocus = Module['_setFocus'] = makeInvalidEarlyAccess('_setFocus');
var _getFocus = Module['_getFocus'] = makeInvalidEarlyAccess('_getFocus');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['setLocationA'] != 'undefined', 'missing Wasm export: setLocationA');
  assert(typeof wasmExports['getLocationALat'] != 'undefined', 'missing Wasm export: getLocationALat');
  assert(typeof wasmExports['getLocationALng'] != 'undefined', 'missing Wasm export: getLocationALng');
  assert(typeof wasmExports['setLocationB'] != 'undefined', 'missing Wasm export: setLocationB');
  assert(typeof wasmExports['getLocationBLat'] != 'undefined', 'missing Wasm export: getLocationBLat');
  assert(typeof wasmExports['getLocationBLng'] != 'undefined', 'missing Wasm export: getLocationBLng');
  assert(typeof wasmExports['setCityIdA'] != 'undefined', 'missing Wasm export: setCityIdA');
  assert(typeof wasmExports['setCityIdB'] != 'undefined', 'missing Wasm export: setCityIdB');
  assert(typeof wasmExports['getCityIdA'] != 'undefined', 'missing Wasm export: getCityIdA');
  assert(typeof wasmExports['getCityIdB'] != 'undefined', 'missing Wasm export: getCityIdB');
  assert(typeof wasmExports['setTimeANow'] != 'undefined', 'missing Wasm export: setTimeANow');
  assert(typeof wasmExports['setTimeBNow'] != 'undefined', 'missing Wasm export: setTimeBNow');
  assert(typeof wasmExports['getTimeANow'] != 'undefined', 'missing Wasm export: getTimeANow');
  assert(typeof wasmExports['getTimeBNow'] != 'undefined', 'missing Wasm export: getTimeBNow');
  assert(typeof wasmExports['setTimeALocal'] != 'undefined', 'missing Wasm export: setTimeALocal');
  assert(typeof wasmExports['setTimeBLocal'] != 'undefined', 'missing Wasm export: setTimeBLocal');
  assert(typeof wasmExports['getTimeALocal'] != 'undefined', 'missing Wasm export: getTimeALocal');
  assert(typeof wasmExports['getTimeBLocal'] != 'undefined', 'missing Wasm export: getTimeBLocal');
  assert(typeof wasmExports['setTimeA'] != 'undefined', 'missing Wasm export: setTimeA');
  assert(typeof wasmExports['setTimeB'] != 'undefined', 'missing Wasm export: setTimeB');
  assert(typeof wasmExports['getTimeAYear'] != 'undefined', 'missing Wasm export: getTimeAYear');
  assert(typeof wasmExports['getTimeAMonth'] != 'undefined', 'missing Wasm export: getTimeAMonth');
  assert(typeof wasmExports['getTimeADay'] != 'undefined', 'missing Wasm export: getTimeADay');
  assert(typeof wasmExports['getTimeAHour'] != 'undefined', 'missing Wasm export: getTimeAHour');
  assert(typeof wasmExports['getTimeAMinute'] != 'undefined', 'missing Wasm export: getTimeAMinute');
  assert(typeof wasmExports['getTimeBYear'] != 'undefined', 'missing Wasm export: getTimeBYear');
  assert(typeof wasmExports['getTimeBMonth'] != 'undefined', 'missing Wasm export: getTimeBMonth');
  assert(typeof wasmExports['getTimeBDay'] != 'undefined', 'missing Wasm export: getTimeBDay');
  assert(typeof wasmExports['getTimeBHour'] != 'undefined', 'missing Wasm export: getTimeBHour');
  assert(typeof wasmExports['getTimeBMinute'] != 'undefined', 'missing Wasm export: getTimeBMinute');
  assert(typeof wasmExports['setTimezoneA'] != 'undefined', 'missing Wasm export: setTimezoneA');
  assert(typeof wasmExports['setTimezoneB'] != 'undefined', 'missing Wasm export: setTimezoneB');
  assert(typeof wasmExports['getTimezoneA'] != 'undefined', 'missing Wasm export: getTimezoneA');
  assert(typeof wasmExports['getTimezoneB'] != 'undefined', 'missing Wasm export: getTimezoneB');
  assert(typeof wasmExports['setNameA'] != 'undefined', 'missing Wasm export: setNameA');
  assert(typeof wasmExports['setNameB'] != 'undefined', 'missing Wasm export: setNameB');
  assert(typeof wasmExports['getNameA'] != 'undefined', 'missing Wasm export: getNameA');
  assert(typeof wasmExports['getNameB'] != 'undefined', 'missing Wasm export: getNameB');
  assert(typeof wasmExports['setTheme'] != 'undefined', 'missing Wasm export: setTheme');
  assert(typeof wasmExports['setAutohideTimeline'] != 'undefined', 'missing Wasm export: setAutohideTimeline');
  assert(typeof wasmExports['getAutohideTimeline'] != 'undefined', 'missing Wasm export: getAutohideTimeline');
  assert(typeof wasmExports['setShowA'] != 'undefined', 'missing Wasm export: setShowA');
  assert(typeof wasmExports['getShowA'] != 'undefined', 'missing Wasm export: getShowA');
  assert(typeof wasmExports['setShowGlobes'] != 'undefined', 'missing Wasm export: setShowGlobes');
  assert(typeof wasmExports['getShowGlobes'] != 'undefined', 'missing Wasm export: getShowGlobes');
  assert(typeof wasmExports['setShowB'] != 'undefined', 'missing Wasm export: setShowB');
  assert(typeof wasmExports['getShowB'] != 'undefined', 'missing Wasm export: getShowB');
  assert(typeof wasmExports['setYearless'] != 'undefined', 'missing Wasm export: setYearless');
  assert(typeof wasmExports['getYearless'] != 'undefined', 'missing Wasm export: getYearless');
  assert(typeof wasmExports['setStarLevel'] != 'undefined', 'missing Wasm export: setStarLevel');
  assert(typeof wasmExports['getStartLevel'] != 'undefined', 'missing Wasm export: getStartLevel');
  assert(typeof wasmExports['setFocus'] != 'undefined', 'missing Wasm export: setFocus');
  assert(typeof wasmExports['getFocus'] != 'undefined', 'missing Wasm export: getFocus');
  ...
  _setLocationA = Module['_setLocationA'] = createExportWrapper('setLocationA', 2);
  _getLocationALat = Module['_getLocationALat'] = createExportWrapper('getLocationALat', 0);
  _getLocationALng = Module['_getLocationALng'] = createExportWrapper('getLocationALng', 0);
  _setLocationB = Module['_setLocationB'] = createExportWrapper('setLocationB', 2);
  _getLocationBLat = Module['_getLocationBLat'] = createExportWrapper('getLocationBLat', 0);
  _getLocationBLng = Module['_getLocationBLng'] = createExportWrapper('getLocationBLng', 0);
  _setCityIdA = Module['_setCityIdA'] = createExportWrapper('setCityIdA', 1);
  _setCityIdB = Module['_setCityIdB'] = createExportWrapper('setCityIdB', 1);
  _getCityIdA = Module['_getCityIdA'] = createExportWrapper('getCityIdA', 0);
  _getCityIdB = Module['_getCityIdB'] = createExportWrapper('getCityIdB', 0);
  _setTimeANow = Module['_setTimeANow'] = createExportWrapper('setTimeANow', 1);
  _setTimeBNow = Module['_setTimeBNow'] = createExportWrapper('setTimeBNow', 1);
  _getTimeANow = Module['_getTimeANow'] = createExportWrapper('getTimeANow', 0);
  _getTimeBNow = Module['_getTimeBNow'] = createExportWrapper('getTimeBNow', 0);
  _setTimeALocal = Module['_setTimeALocal'] = createExportWrapper('setTimeALocal', 1);
  _setTimeBLocal = Module['_setTimeBLocal'] = createExportWrapper('setTimeBLocal', 1);
  _getTimeALocal = Module['_getTimeALocal'] = createExportWrapper('getTimeALocal', 0);
  _getTimeBLocal = Module['_getTimeBLocal'] = createExportWrapper('getTimeBLocal', 0);
  _setTimeA = Module['_setTimeA'] = createExportWrapper('setTimeA', 5);
  _setTimeB = Module['_setTimeB'] = createExportWrapper('setTimeB', 5);
  _getTimeAYear = Module['_getTimeAYear'] = createExportWrapper('getTimeAYear', 0);
  _getTimeAMonth = Module['_getTimeAMonth'] = createExportWrapper('getTimeAMonth', 0);
  _getTimeADay = Module['_getTimeADay'] = createExportWrapper('getTimeADay', 0);
  _getTimeAHour = Module['_getTimeAHour'] = createExportWrapper('getTimeAHour', 0);
  _getTimeAMinute = Module['_getTimeAMinute'] = createExportWrapper('getTimeAMinute', 0);
  _getTimeBYear = Module['_getTimeBYear'] = createExportWrapper('getTimeBYear', 0);
  _getTimeBMonth = Module['_getTimeBMonth'] = createExportWrapper('getTimeBMonth', 0);
  _getTimeBDay = Module['_getTimeBDay'] = createExportWrapper('getTimeBDay', 0);
  _getTimeBHour = Module['_getTimeBHour'] = createExportWrapper('getTimeBHour', 0);
  _getTimeBMinute = Module['_getTimeBMinute'] = createExportWrapper('getTimeBMinute', 0);
  _setTimezoneA = Module['_setTimezoneA'] = createExportWrapper('setTimezoneA', 1);
  _setTimezoneB = Module['_setTimezoneB'] = createExportWrapper('setTimezoneB', 1);
  _getTimezoneA = Module['_getTimezoneA'] = createExportWrapper('getTimezoneA', 0);
  _getTimezoneB = Module['_getTimezoneB'] = createExportWrapper('getTimezoneB', 0);
  _setNameA = Module['_setNameA'] = createExportWrapper('setNameA', 1);
  _setNameB = Module['_setNameB'] = createExportWrapper('setNameB', 1);
  _getNameA = Module['_getNameA'] = createExportWrapper('getNameA', 0);
  _getNameB = Module['_getNameB'] = createExportWrapper('getNameB', 0);
  _setTheme = Module['_setTheme'] = createExportWrapper('setTheme', 1);
  _setAutohideTimeline = Module['_setAutohideTimeline'] = createExportWrapper('setAutohideTimeline', 1);
  _getAutohideTimeline = Module['_getAutohideTimeline'] = createExportWrapper('getAutohideTimeline', 0);
  _setShowA = Module['_setShowA'] = createExportWrapper('setShowA', 1);
  _getShowA = Module['_getShowA'] = createExportWrapper('getShowA', 0);
  _setShowGlobes = Module['_setShowGlobes'] = createExportWrapper('setShowGlobes', 1);
  _getShowGlobes = Module['_getShowGlobes'] = createExportWrapper('getShowGlobes', 0);
  _setShowB = Module['_setShowB'] = createExportWrapper('setShowB', 1);
  _getShowB = Module['_getShowB'] = createExportWrapper('getShowB', 0);
  _setYearless = Module['_setYearless'] = createExportWrapper('setYearless', 1);
  _getYearless = Module['_getYearless'] = createExportWrapper('getYearless', 0);
  _setStarLevel = Module['_setStarLevel'] = createExportWrapper('setStarLevel', 1);
  _getStartLevel = Module['_getStartLevel'] = createExportWrapper('getStartLevel', 0);
  _setFocus = Module['_setFocus'] = createExportWrapper('setFocus', 1);
  _getFocus = Module['_getFocus'] = createExportWrapper('getFocus', 0);
