...
function findWasmBinary() {
  return locateFile('glslViewer.wasm');
}
...
var _setShaders = Module['_setShaders'] = makeInvalidEarlyAccess('_setShaders');
var _loadAsset = Module['_loadAsset'] = makeInvalidEarlyAccess('_loadAsset');
var _loadTexture = Module['_loadTexture'] = makeInvalidEarlyAccess('_loadTexture');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['setShaders'] != 'undefined', 'missing Wasm export: setShaders');
  assert(typeof wasmExports['loadAsset'] != 'undefined', 'missing Wasm export: loadAsset');
  assert(typeof wasmExports['loadTexture'] != 'undefined', 'missing Wasm export: loadTexture');
  ...
  _query = Module['_query'] = createExportWrapper('query', wasmExports['query'], 1);
  _setFrag = Module['_setFrag'] = createExportWrapper('setFrag', wasmExports['setFrag'], 1);
  _setVert = Module['_setVert'] = createExportWrapper('setVert', wasmExports['setVert'], 1);
  _setShaders = Module['_setShaders'] = createExportWrapper('setShaders', wasmExports['setShaders'], 2);
  _loadAsset = Module['_loadAsset'] = createExportWrapper('loadAsset', wasmExports['loadAsset'], 2);
  _loadTexture = Module['_loadTexture'] = createExportWrapper('loadTexture', wasmExports['loadTexture'], 2);
  _getFrag = Module['_getFrag'] = createExportWrapper('getFrag', wasmExports['getFrag'], 0);
  _getVert = Module['_getVert'] = createExportWrapper('getVert', wasmExports['getVert'], 0);
  _getDefaultSceneFrag = Module['_getDefaultSceneFrag'] = createExportWrapper('getDefaultSceneFrag', wasmExports['getDefaultSceneFrag'], 0);
  _getDefaultSceneVert = Module['_getDefaultSceneVert'] = createExportWrapper('getDefaultSceneVert', wasmExports['getDefaultSceneVert'], 0);
