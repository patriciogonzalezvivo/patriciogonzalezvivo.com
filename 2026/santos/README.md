...
Technically, these portraits are a continuation of an exploration using drawing machines started [in 2014 on Skylines](../../2014/skylines/skylines.php?v=01). For It I construct a wall plotter that slowly reveals an image of the world viewed through the tireless eye of technology using a custom software that translates photographs into a series of lines.

Back in 2025, with [Hybrids Portraits series](../../2025/hybrids/) I begin experimenting with the process of combining plotting with alla prima oil painting. This method brings together the forces of machine and hand, code and gesture. In Santos, I'm using a that approach of converting portrait images into vector paths layered with symbolical elements singular to each subject, then plotting the results with acrylic paint on a prime canvas, to finish rendering the portrait by hand with oil paint.
