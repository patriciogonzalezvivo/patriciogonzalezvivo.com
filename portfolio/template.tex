...
\fancyhead[R]{\footnotesize %%HEADER_TITLE%%}
...
\textbf{Email}    & \href{mailto:%%ARTIST_EMAIL%%}{%%ARTIST_EMAIL%%} \\
\textbf{Web}      & \href{%%ARTIST_WEBSITE_URL%%}{%%ARTIST_WEBSITE%%} \\
\textbf{Instagram} & \href{https://instagram.com/%%ARTIST_INSTAGRAM%%}{@%%ARTIST_INSTAGRAM%%} \\
\end{tabular}
\end{minipage}%
\hfill
