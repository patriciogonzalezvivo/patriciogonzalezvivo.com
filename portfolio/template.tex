...
% PAGE LAYOUT
% ---------------------------------------------------------
\usepackage[a4paper, landscape, margin=0.8in, headheight=18pt, headsep=12pt]{geometry}
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small {\addfontfeature{LetterSpace=8}\href{%%ARTIST_WEBSITE_URL%%}{\MakeUppercase{%%ARTIST_NAME%%}}}}
...
\raggedright
\begin{tabular}{rl}
% \textbf{Name}:     & %%ARTIST_NAME%%     \\
\textbf{Location} & %%ARTIST_LOCATION%% \\
\textbf{Phone}    & %%ARTIST_PHONE%%    \\
\textbf{Email}    & \href{mailto:%%ARTIST_EMAIL%%}{%%ARTIST_EMAIL_LABEL%%} \\
\textbf{Web}      & \href{%%ARTIST_WEBSITE_URL%%}{%%ARTIST_WEBSITE%%} \\
\textbf{Instagram} & \href{https://instagram.com/%%ARTIST_INSTAGRAM%%}{@%%ARTIST_INSTAGRAM_LABEL%%} \\
\end{tabular}
\end{minipage}%
\hfill
